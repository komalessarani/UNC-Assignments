...
// return new Promise(((resolve, reject) => {
    setTimeout(()=> {
      let hero1 = {};
      let hero2 = {};
      Promise.all([getHeroByIdAsync(heroData, hero1Id), getHeroByIdAsync(heroData, hero2Id)]).then(heroes=>{
        return ({huhhero1: hero1, hero2: hero2});
      })
      // let hero1 = getHeroByIdAsync(heroData, hero1Id);
      // let hero2 = getHeroByIdAsync(heroData, hero2Id);

      // if(hero1 == null || hero2 == null){
      //   reject('No heros found');
      // }
      // resolve({hero1: hero1, hero2: hero2})
    }, 1500);
  // }));
